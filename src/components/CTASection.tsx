  ...
  <section id="booking" className="section-padding relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 md:px-8 relative z-10">
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}
        ...
        <p className="text-muted-foreground mt-4 text-sm max-w-md mx-auto">Let's talk about your business goals. No pressure, no jargon — just real advice from people who care.</p>
        <button className="mt-8 bg-primary text-primary-foreground font-body font-semibold px-10 py-4 rounded-button glow-green hover:brightness-110 transition-all inline-flex items-center gap-2 text-lg">
          Book Your Free Call <ArrowRight size={20} />
        </button>
        <p className="text-muted-foreground text-xs mt-4">hello@webcraft.in</p>
